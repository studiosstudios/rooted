...
public:
     ...
     */
    bool initWithSheet(const std::shared_ptr<Texture>& texture, int rows, int cols) {
     ...
     * @return  true if the filmstrip is initialized properly, false otherwise.
     */
    bool initWithSheet(const std::shared_ptr<Texture>& texture, int rows, int cols, int size);
...
#pragma mark Static Constructors
     ...
     */
    static std::shared_ptr<SpriteNode> allocWithSheet(const std::shared_ptr<Texture>& texture,
                                                      int rows, int cols) {
    ...
    /**
     * Returns a newly allocated filmstrip as a copy of the given one.
     *
