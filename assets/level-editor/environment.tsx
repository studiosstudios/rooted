...
<tileset version="1.10" tiledversion="1.10.1" name="environment" tilewidth="2204" tileheight="2048" tilecount="14" columns="0">
 <grid orientation="orthogonal" width="1" height="1"/>
 <tile id="0" type="PlantingSpot">
  <image width="96" height="96" source="rootingSpotTemp.png"/>
 </tile>
 <tile id="1" type="Rock">
  <image width="512" height="512" source="../textures/rock.png"/>
 </tile>
 <tile id="2" type="Decoration">
  <properties>
   <property name="frame_cols" type="int" value="1"/>
   <property name="frame_rows" type="int" value="1"/>
   <property name="name" value="barn"/>
  </properties>
  <image width="2204" height="1715" source="../textures/barn.png"/>
 </tile>
 <tile id="3" type="Decoration">
  <properties>
   <property name="frame_cols" type="int" value="4"/>
 ...
 <tile id="4" type="Decoration">
  ...
  <image width="944" height="1893" source="../textures/scarecrow.png"/>
 </tile>
 <tile id="6" type="Decoration">
  <properties>
   <property name="frame_cols" type="int" value="5"/>
   <property name="frame_rows" type="int" value="3"/>
   <property name="name" value="mill"/>
  </properties>
  <image width="1620" height="2007" source="../textures/mill_single.png"/>
 </tile>
